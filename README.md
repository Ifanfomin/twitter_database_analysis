...
Первым делом нужно узнать количество аккаунтов выбранной страны. Удобнее всего это реализовать через гистограмму, где столбцы - страны, а их высота - количество регистраций. Теперь мы производим поиск по столбцу местоположения регистрации, перебирая регионы.
```
